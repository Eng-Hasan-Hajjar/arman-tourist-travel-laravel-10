...
<li class="nav-item has-treeview">
    ...
    <ul class="nav nav-treeview">
      <li class="nav-item">
        <a href="{{url('/adminpanel/museums/create')}}" class="nav-link">
          <i class="far fa-circle nav-icon"></i>
          <p>Add Armenia museums</p>
        </a>
      </li>
      <li class="nav-item">
        <a href="{{url('/adminpanel/museums ')}}" class="nav-link">
          <i class="far fa-circle nav-icon"></i>
          <p>All Armenia museums</p>
        </a>
      </li>
...
<li class="nav-item has-treeview">
    ...
    <ul class="nav nav-treeview">
      <li class="nav-item">
        <a href="{{url('/adminpanel/springs/create')}}" class="nav-link">
          <i class="far fa-circle nav-icon"></i>
          <p>Add Armenia springs</p>
        </a>
      </li>
      <li class="nav-item">
        <a href="{{url('/adminpanel/springs ')}}" class="nav-link">
          <i class="far fa-circle nav-icon"></i>
          <p>All Armenia springs</p>
        </a>
      </li>
