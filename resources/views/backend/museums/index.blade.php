...
@section('content')
                ...
                <div class="container hcontainer"  >
                    <div class="card hcard helement hcard-body" >
                        ...
                        <div class="card-header"><p  class="float-left">all museums </p></div>
                        <div class="card-header">
                            <a href="{{ route('museums.create') }}" class=" btn btn-success float-right">create new </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($museums as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('museums.show', $row->id) }}"
                                                    class="btn btn-primary">Show</a>
                                                <a href="{{ route('museums.edit', $row->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <form method="post" class="delete_form"
                                                    action="{{ route('museums.destroy', $row->id) }}">
                                                    {{ csrf_field() }}
