...
@section('content')
                ...
                <div class="container hcontainer"  >
                    <div class="card hcard helement hcard-body" >
                        ...
                        <div class="card-header"><p  class="float-left">all theaters </p></div>
                        <div class="card-header">
                            <a href="{{ route('theaters.create') }}" class=" btn btn-success float-right">create new </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($theaters as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('theaters.show', $row->id) }}"
                                                    class="btn btn-primary">Show</a>
                                                <a href="{{ route('theaters.edit', $row->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <form method="post" class="delete_form"
                                                    action="{{ route('theaters.destroy', $row->id) }}">
                                                    {{ csrf_field() }}
