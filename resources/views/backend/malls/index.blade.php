...
@section('content')
                ...
                <div class="container hcontainer"  >
                    <div class="card hcard helement hcard-body" >
                        ...
                        <div class="card-header"><p  class="float-left">all malls </p></div>
                        <div class="card-header">
                            <a href="{{ route('malls.create') }}" class=" btn btn-success float-right">create new </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($malls as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('malls.show', $row->id) }}"
                                                    class="btn btn-primary">Show</a>
                                                <a href="{{ route('malls.edit', $row->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <form method="post" class="delete_form"
                                                    action="{{ route('malls.destroy', $row->id) }}">
                                                    {{ csrf_field() }}
