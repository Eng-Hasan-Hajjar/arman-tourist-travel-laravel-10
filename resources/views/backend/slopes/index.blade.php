...
@section('content')
                ...
                <div class="container hcontainer"  >
                    <div class="card hcard helement hcard-body" >
                        ...
                        <div class="card-header"><p  class="float-left">all slopes </p></div>
                        <div class="card-header">
                            <a href="{{ route('slopes.create') }}" class=" btn btn-success float-right">create new </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($slopes as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('slopes.show', $row->id) }}"
                                                    class="btn btn-primary">Show</a>
                                                <a href="{{ route('slopes.edit', $row->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <form method="post" class="delete_form"
                                                    action="{{ route('slopes.destroy', $row->id) }}">
                                                    {{ csrf_field() }}
