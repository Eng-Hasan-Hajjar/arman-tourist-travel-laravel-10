...
@section('content')
                ...
                <div class="container hcontainer"  >
                    <div class="card hcard helement hcard-body" >
                        ...
                        <div class="card-header"><p  class="float-left">all mountains </p></div>
                        <div class="card-header">
                            <a href="{{ route('mountains.create') }}" class=" btn btn-success float-right">create new </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($mountains as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('mountains.show', $row->id) }}"
                                                    class="btn btn-primary">Show</a>
                                                <a href="{{ route('mountains.edit', $row->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <form method="post" class="delete_form"
                                                    action="{{ route('mountains.destroy', $row->id) }}">
                                                    {{ csrf_field() }}
