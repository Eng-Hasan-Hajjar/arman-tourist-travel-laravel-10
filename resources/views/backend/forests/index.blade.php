...
@section('content')
                ...
                <div class="container hcontainer"  >
                    <div class="card hcard helement hcard-body" >
                        ...
                        <div class="card-header"><p  class="float-left">all forests </p></div>
                        <div class="card-header">
                            <a href="{{ route('forests.create') }}" class=" btn btn-success float-right">create new </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($forests as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('forests.show', $row->id) }}"
                                                    class="btn btn-primary">Show</a>
                                                <a href="{{ route('forests.edit', $row->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <form method="post" class="delete_form"
                                                    action="{{ route('forests.destroy', $row->id) }}">
                                                    {{ csrf_field() }}
