...
@section('content')
                ...
                <div class="container hcontainer"  >
                    <div class="card hcard helement hcard-body" >
                        ...
                        <div class="card-header"><p  class="float-left">all places </p></div>
                        <div class="card-header">
                            <a href="{{ route('places.create') }}" class=" btn btn-success float-right">create new </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($places as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('places.show', $row->id) }}"
                                                    class="btn btn-primary">Show</a>
                                                <a href="{{ route('places.edit', $row->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <form method="post" class="delete_form"
                                                    action="{{ route('places.destroy', $row->id) }}">
                                                    {{ csrf_field() }}
