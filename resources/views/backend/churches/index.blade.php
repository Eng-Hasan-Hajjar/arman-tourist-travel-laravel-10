...
@section('content')
                ...
                <div class="container hcontainer"  >
                    <div class="card hcard helement hcard-body" >
                        ...
                        <div class="card-header"><p  class="float-left">all churches </p></div>
                        <div class="card-header">
                            <a href="{{ route('churches.create') }}" class=" btn btn-success float-right">create new </a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($churches as $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('churches.show', $row->id) }}"
                                                    class="btn btn-primary">Show</a>
                                                <a href="{{ route('churches.edit', $row->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <form method="post" class="delete_form"
                                                    action="{{ route('churches.destroy', $row->id) }}">
                                                    {{ csrf_field() }}
